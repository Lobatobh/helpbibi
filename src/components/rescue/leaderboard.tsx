...
export function Leaderboard() {
  ...
  const medals = [
    { icon: Crown, color: 'text-sky-400', bg: 'from-sky-500/20 to-sky-500/5', border: 'border-sky-500/40' },
    ...
    <div className="rounded-2xl border border-slate-800 bg-slate-900/40 p-5">
      <div className="mb-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-sky-400 to-sky-600 text-slate-950">
        ...
        <div className="flex gap-1 rounded-full border border-slate-700 bg-slate-800/50 p-0.5">
          <button
            ...
            className={`rounded-full px-3 py-1 text-[10px] font-semibold transition ${
              period === 'today' ? 'bg-sky-500 text-slate-950' : 'text-slate-400 hover:text-white'
            }`}
          >
            Hoje
          </button>
          <button
            ...
            className={`rounded-full px-3 py-1 text-[10px] font-semibold transition ${
              period === 'total' ? 'bg-sky-500 text-slate-950' : 'text-slate-400 hover:text-white'
            }`}
          >
            Total
          </button>
          ...
          {sortedEntries.map((entry, i) => {
            ...
            return (
              ...
              >
                ...
                <Avatar className="h-9 w-9 bg-gradient-to-br from-orange-500 to-orange-700">
                ...
                <div className="flex shrink-0 items-center gap-3 text-right">
                  <div>
                    <p className="flex items-center gap-0.5 text-xs font-bold text-sky-400">
