...
export type GatewayWebhookEvent = { event: 'AUTHORIZED'|'PAID'|'FAILED'|'CANCELED'|'REFUNDED'|'WEBHOOK_RECEIVED'; providerPaymentId?: string; externalReference?: string; message: string; rawPayload: Record<string, any> }
